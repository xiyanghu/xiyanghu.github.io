...
> Xiyang Hu: 
> 
> I commented out line 36-45 of _includes/header.html to remove the tab of "blog" on the header.
> 
> There was an error "GitHub Metadata: No GitHub API authentication could be found. Some fields may be missing or have incorrect data.". I solved it by by adding `github: [metadata]` to _config.yml. See [this](https://github.com/github/pages-gem/issues/399).
>
> Add `order` to all .md files in _pages, and change line 48 of from `sort: "title"` to `sort: "order"` to reorder the pages on the header.
